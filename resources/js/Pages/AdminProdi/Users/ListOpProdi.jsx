...
const ListOpProdi = ({ base_url, message, props }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `${base_url}/api/admin/users/operator-prodi?page=${currentPage}&search_key=${searchKey}`
            );
    ...
    const deleteRecords = async (id_opt) => {
        if (id_opt === null) {
            return;
        }
        setLoading(true);
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/admin/users/operator-prodi/delete/${id_opt}`
            );
            fetchData();
        } catch (err) {
            setError(err.response?.data?.message || "Something went wrong.");
                    ...
                    <div className="mx-auto ">
                        <div className="flex justify-between items-center py-3">
                            ...
                            <ul className="flex gap-x-3">
                                ...
                                <li>{"/"}</li>
                                <li className="text-primary2-600">
                                    Operator Prodi
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                                <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                    <button
                                        ...
                                        onClick={(e) =>
                                            router.visit(
                                                "/admin/users/operator-prodi/add"
                                            )
                                        }
                                    >
                                        <svg
                                ...
                                <div className="flex items-center w-full">
                                    ...
                                    <div className="relative w-full">
                                        <input
                                            ...
                                            placeholder="Search Nama Operator..."
                                            required
                                        />
                                    </div>
                                    <button
