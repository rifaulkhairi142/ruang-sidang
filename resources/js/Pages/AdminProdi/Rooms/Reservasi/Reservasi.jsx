...
const Reservasi = ({ base_url, message, props, flash, auth }) => {
    ...
    const [notify, setNotify] = useState(message !== null ? true : false);
    const [notifyStatus, setNotifyStatus] = useState("default");

    const [resp, setRsp] = useState(null);
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `${base_url}/api/operator-prodi/rooms/reservasi?page=${
                    currentPage || 1
                }&search_key=${searchKey}&booking_date=${date}`
            );
    ...
    //     router.post(`/operator-prodi/rooms/reservasi/delete/${id}`);
    // };
    ...
    const deleteRecords = async (id) => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/operator-prodi/rooms/reservasi/delete/${id}`,
                { email: auth?.email }
            );
                        ...
                        <div className="flex justify-between items-center py-3">
                            ...
                            <ul className="flex gap-x-3">
                                <li
                                    ...
                                    onClick={() =>
                                        router.get("/operator-prodi/dashboard")
                                    }
                                >
                                    Dashboard
                                </li>
                                ...
                                <div className="flex items-center w-full">
                                    ...
                                    <div className="relative w-full">
                                        <input
                                            ...
                                            id="simple-search"
                                            className="bg-gray-50 border h-13 border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full ps-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Search..."
                                            required
                                        />
                                    </div>
                                                            ...
                                                            <ul className="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                                <li>
                                                                    <a
                                                                        onClick={() => {
                                                                            router.get(
                                                                                `/operator-prodi/rooms/reservasi/detail/${item.id}`
                                                                            );
                                                                            setDropdownOpen(
                                                                                null
                                                                            );
