import BookingCart from "@/Components/Admin/Chart/BookingCart";
            ...
            <div className="flex flex-col gap-y-3">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <CardDataStats
                        ...
                        levelUp
                    >
                        <BsBuildingCheck className="text-primary text-xl" />
                    </CardDataStats>
                </div>
                <BookingCart data={data?.this_week} />
            </div>
        </AdminLayout>
    );
};
