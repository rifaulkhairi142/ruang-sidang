...
const Reservasi = ({ base_url, message, props }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `${base_url}/api/admin/rooms/reservasi?page=${currentPage}&search_key=${searchKey}&booking_date=${date}`
            );
    ...
    const deleteRecords = async (id) => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/admin/rooms/reservasi/delete/${id}`
            );
            fetchData();
        } catch (err) {
            setError(err.response?.data?.message || "Something went wrong.");
                    ...
                    <div className="mx-auto ">
                        <div className="flex justify-between items-center py-3">
                            ...
                            <ul className="flex gap-x-3">
                                ...
                                <li>{"/"}</li>
                                <li className="text-primary2-600">Reservasi</li>
                            </ul>
                        </div>
                                ...
                                <div className="flex items-center w-full">
                                    ...
                                    <div className="relative w-full">
                                        <input
                                            ...
                                            id="simple-search"
                                            className="bg-gray-50 border border-gray-300 h-13 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <button
                                        ...
                                        className="p-2.5 flex justify-center ms-2 w-13 text-center text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    >
                                        <svg
                                            className="w-4 h-4"
                                            aria-hidden="true"
                                                            ...
                                                            <ul className="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                                <li>
                                                                    <a
                                                                        onClick={() => {
                                                                            router.get(
                                                                                `/admin/rooms/reservasi/detail/${item.id}`
                                                                            );
                                                                            setDropdownOpen(
                                                                                null
                                                                            );
...
const getUserStatus = (status) => {
    if (status === "Diterima") {
        return <Chip label={status} variant="filled" color="success"></Chip>;
    } else if (status === "Ditolak") {
        return <Chip label={status} variant="filled" color="error"></Chip>;
    } else if (status === "Revisi") {
        return <Chip label={status} variant="filled" color="warning"></Chip>;
    } else if (status === "In Review") {
        return <Chip label={status} variant="filled" color="primary"></Chip>;
    } else {
        return <Chip label={status} variant="filled" color="default"></Chip>;
    }
};
