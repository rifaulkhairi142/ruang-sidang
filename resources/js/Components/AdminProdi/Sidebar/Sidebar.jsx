                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <NavLink
                                                            href="/operator-prodi/rooms/reservasi"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                                                pathname ===
                                                                    "/operator-prodi/rooms/reservasi" ||
                                                                (pathname.includes(
                                                                    "reservasi/detail"
                                                                ) &&
                                                                    "text-white")
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            href="/operator-prodi/rooms/reservasi/add"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                                                pathname ===
                                                                    "/admin/rooms/reservasi" &&
                                                                "text-white"
                                                            }`}
                                                        >
                                                            Buat Reservasi
